...
function _18d(node){
node.each(function(){
try{ //mod by  add try catch to prevent the error __flash__removeCallback 未定义 when close the tab which contains flash 
$(this).remove();
if($.browser.msie){
this.outerHTML="";
}}
...
_705.find("input.combo-text").width(_705.width()-_707 - 3); //modify by 
