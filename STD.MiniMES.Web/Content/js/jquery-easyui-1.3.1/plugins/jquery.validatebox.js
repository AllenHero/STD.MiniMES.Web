...
(function ($) {
    ...
    function _10(_11) {
        ...
        if (tip) {
            //modify by  start 20121206 for fix the tip over the screen
            ...
            //modify by  end 20121206 for fix the tip over the screen
        }
    };
    function _b(_12) {
    ...
    function _13(_14) {
        ...
        if (_16.validType) {
            // add by  2012-12-27 start for support multiple validType like validType="xxx&xxx"
            var _validTypes = (_16.validType).split(/&/g);
            for (var _i = 0; _i < _validTypes.length; _i++) {
                var vType = _validTypes[_i];
            // add by  2012-12-27 end
