...
namespace STD.MiniMES.Web
{
    public partial class report : System.Web.UI.Page
    {
        ...
        {
            //((Stimulsoft.Report.Dictionary.StiSqlDatabase)(report.Dictionary.Databases["Connection1"])).ConnectionString = ConfigurationManager.ConnectionStrings["MiniMES"].ConnectionString;
            //foreach (Stimulsoft.Report.Dictionary.StiSqlDatabase item in report.Dictionary.Databases)
            //{
            //    var prefix = item.Name.Split('_')[0];
            //    var test = ConfigurationManager.ConnectionStrings["MiniMES"];
